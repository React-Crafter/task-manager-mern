        ...
        <div className='flex justify-center w-full h-full login-bg'>
            ...
            <div className='pt-16 w-[30%]'>
                <div className='flex items-center justify-center gap-3 mb-8'>
                    <div className='p-3 rounded-xl bg-[#7c3bed1a] glow'> <img src={logo} alt="" /> </div>
                ...
                <div className='glass rounded-2xl p-7'>
                    ...
                    <form className='space-y-5 mb-4'>
                        ...
                        <button className='inline-flex hover:cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8b5cf6] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-hovered h-10 px-4 py-2 w-full glow'> Login </button>
                    </form>
